  ...
  return (
    <Container>
      <Content>
        ...
        <Text>
          You can be one of the <InlineText color="#EE10B0">members</InlineText>{" "}
          of our platform by just adding some necessary information. If you
          already have an account on our website, you can just hit the{" "}
          <InlineText color="#0E9EEF">Login button</InlineText>.
        </Text>
      </Content>
      <Features>
        <Option>
        ...
        <div className="inline-flex gap-[8px]">
          <ViewInput>
            ...
            <InputWrapper>
              <IconComponent icon={FaUser} color="#FFF" size={24} />
              <Input
          ...
          <ViewInput>
            ...
            <InputWrapper>
              <IconComponent icon={FiPhone} color="#FFF" size={24} />
              <Input
        ...
        <div className="flex-col flex w-full gap-[8px] mt-[8px]">
          ...
          <div className="h-[40px] inline-flex align-middle items-center border-x border-y pl-[10px] rounded-[8px] border-white ">
            <IconComponent icon={MdOutlineMail} size={24} color="#FFF" />
            <InputMail
        ...
        >
          <ImageIcon
            src={require("src/assets/images/icon_gg.png")}
            style={{
              width: 36,
              height: 36,
              background: "transparent",
